...
void print_usage(const char* program_name) {
    std::cout << "Usage: " << program_name << " <config_yaml> [options]\n"
                ...
                << "Example: " << program_name << " examples/ocsort/config/ocsort.yaml [--video test.mp4]\n"
                << "         " << program_name << " examples/ocsort/config/ocsort.yaml --use-camera --camera-id 0\n";
}
