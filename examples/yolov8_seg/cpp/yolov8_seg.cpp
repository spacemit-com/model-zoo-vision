...
void print_usage(const char* program_name) {
    std::cout << "Usage: " << program_name << " <config_yaml> [options]\n"
                ...
                << "  --output <path>       Output image path (default: yolov8_seg_result.jpg)\n"
                ...
                << "\nExample:\n"
                << "  " << program_name << " examples/yolov8_seg/config/yolov8_seg.yaml\n"
                << "  " << program_name
                << " examples/yolov8_seg/config/yolov8_seg.yaml --image test.jpg --output result.jpg\n";
}
...
int main(int argc, char* argv[]) {
    ...
    std::string output_path = "yolov8_seg_result.jpg";
    ...
    if (use_camera) {
        ...
        std::cout << "Real-time instance segmentation. Press 'q' to quit, 's' to save..." << std::endl;
        cv::Mat frame;
        int frame_count = 0;
        ...
        std::cout << "Running instance segmentation..." << std::endl;
        ...
        if (!response.results.empty()) {
            std::cout << "Detected " << response.results.size() << " objects with segmentation masks" << std::endl;
            cv::Mat vis;
