...
"""
YOLOv11 Detection Example using CV Model Factory

This example demonstrates how to use YOLOv11 detector through the CV model factory.
"""
...
def parse_args():
    parser = argparse.ArgumentParser(description="YOLOv11 Detection Example")
    parser.add_argument("--config", type=str, default=None,
                       help="Config yaml path (default: examples/yolov11/config/yolov11.yaml)")
    parser.add_argument("--model-path", type=str, default=None,
                       help="Override model_path in yaml")
    parser.add_argument("--image", type=str,
                       help="Input image path (if not provided, uses config default)")
    parser.add_argument("--output", type=str, default="yolo11_result.jpg",
...
def main():
    ...
    try:
        # Config 位于 examples/yolov11/config，资源路径相对 model_zoo/cv
        default_config = Path(__file__).parent.parent / "config" / "yolov11.yaml"
