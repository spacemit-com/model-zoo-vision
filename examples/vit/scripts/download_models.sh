#!/bin/sh
# Download model(s) for vit example. Saved to ~/.cache/models/vision/vit/
# Download URLs for this example. Run with: sh download_models.sh

set -e
CACHE_BASE="${HOME:-/tmp}/.cache/models/vision"
MODEL_DIR="$CACHE_BASE/vit"
mkdir -p "$MODEL_DIR"

BASE_URL="https://archive.spacemit.com/spacemit-ai/model_zoo/vision/vit"
download() {
  name="$1"
...
download "vit_b_16.q.onnx"
download "vit_b_16.fp16.onnx"
